...
//        m.writer().writeByte(0);
    ...
    public static void chat_KTG(Session conn, Message m2) throws IOException {
        ...
        if (text != null) {
            ...
            if (text2.contains("reset") || text2.contains("open") || text2.contains("djt") || text2.contains("dit") || text2.contains("dcm") || text2.contains("deo") || text2.contains("đéo") || text2.contains("địt") || text2.contains("đjt") || text2.contains("đcm") || text2.contains("admin")) {
