    ...
    public void change_new_date() throws IOException {
        if (!Util.is_same_day(Date.from(Instant.now()), date) && isOwner) {
            ...
            if (Manager.gI().ty_phu.contains(this.name)) {
                short it7 = (short) Util.random(326, 336);
                short gems = (short) Util.random(10000, 20000);
                ids.add(new BoxItem(it7, (short) 5, (byte) 7));
                ids.add(new BoxItem((short) -2, gems, (byte) 4));
                this.update_ngoc(gems);
                Item47 it = new Item47();
                it.id = it7;
                it.quantity = 5;
                this.item.add_item_inventory47(7, it);
                freez2 = 3;
            } else if (Manager.gI().trieu_phu.contains(this.name)) {
                short it7 = (short) Util.random(226, 236);
                short gems = (short) Util.random(5000, 10000);
                ids.add(new BoxItem(it7, (short) 5, (byte) 7));
                ids.add(new BoxItem((short) -2, gems, (byte) 4));
                this.update_ngoc(gems);
                Item47 it = new Item47();
                ...
                short it7 = (short) Util.random(126, 136);
                short gems = (short) Util.random(1000, 5000);
                ids.add(new BoxItem(it7, (short) 5, (byte) 7));
                ids.add(new BoxItem((short) -2, gems, (byte) 4));
                this.update_ngoc(gems);
                Item47 it = new Item47();
