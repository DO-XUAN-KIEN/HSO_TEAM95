...
//                }
                ...
                case 122: {
                    ...
                    conn.p.item.inventory3[conn.p.item_replace2].tier = conn.p.item.inventory3[conn.p.item_replace].tier;
